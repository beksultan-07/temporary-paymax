<template>
  <v-app>
    <v-app-bar color="transparent" absolute flat app>
      <v-toolbar-title>
        <b class="mx-2">
          <nuxt-link :class="(this.$vuetify.theme.dark ? 'white' : 'black') + '--text text-decoration-none'" to="/">
            EXCHANGE <span class="red--text">BETA</span>
            <!--<svg class="mt-2" width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg">
