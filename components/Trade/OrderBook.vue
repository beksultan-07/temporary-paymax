...
<script>
  ...
  export default {
    ...
    mounted() {
       ...
       * @object {value: float}
       */
      this.$publish.bind('exchange/order/status', '22109', (data) => {
       ...
       * @object {value: float}
       */
      this.$publish.bind('exchange/order/create', '12041', (data) => {
       ...
       * @object {value: float},
       */
      this.$publish.bind('exchange/order/cancel', '57660', (data) => {
