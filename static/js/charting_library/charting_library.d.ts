...
export interface ChartingLibraryWidgetConstructor {
  new(options: { studies_overrides: {}, symbol, charts_storage_url: string, datafeed: Datafeed, locale: string, client_id: string, enabled_features: [string], fullscreen: boolean, user_id: string, charts_storage_api_version: string, theme: (string), interval: string, container_id: string, library_path: string, disabled_features: string[], autosize: boolean }): IChartingLibraryWidget;
}
