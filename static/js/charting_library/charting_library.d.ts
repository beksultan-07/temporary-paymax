...
export interface ChartingLibraryWidgetConstructor {
	new(options: { container: string, symbol, datafeed: Datafeed, locale: string, client_id: string, fullscreen: boolean, user_id: string, charts_storage_api_version: string, theme: (string), interval: string, library_path: string, disabled_features: string[], autosize: boolean }): IChartingLibraryWidget;
}
