    ...
    <v-flex mx5 sm6 md4 xl3 align-self-center>
      <template v-if="finish">
        ...
        <div class="text-center">
          ...
          <v-btn color="black--text yellow darken-1 text-capitalize mt-3" width="200" large elevation="0" to="/signin">{{ $vuetify.lang.t('$vuetify.lang_29') }}</v-btn>
        </div>
        <!-- End: finish message -->
      ...
      <template v-else>
        ...
        <v-stepper class="transparent" v-model="next" vertical flat>
          ...
          <v-stepper-step color="black--text yellow darken-1" :complete="next > 3" step="3">
          ...
          <v-stepper-content step="3">
            <v-form class="mt-2" ref="form2">
              ...
              <v-text-field color="yellow darken-3" outlined :label="$vuetify.lang.t('$vuetify.lang_9')" :rules="rulesConfirm" :type="print ? 'text' : 'password'" required>
                <template #message="{ message }">
                  {{ $vuetify.lang.t(message) }}
                </template>
              </v-text-field>
